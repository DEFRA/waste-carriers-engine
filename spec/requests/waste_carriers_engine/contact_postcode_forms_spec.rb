        ...
        context "when a valid transient registration exists" do
          ...
          context "when valid params are submitted" do
            ...
            it "returns a 302 response" do
              post contact_postcode_forms_path(transient_registration._id), contact_postcode_form: valid_params
            ...
            it "redirects to the contact_address form" do
              post contact_postcode_forms_path(transient_registration._id), contact_postcode_form: valid_params
              expect(response).to redirect_to(new_contact_address_form_path(transient_registration[:_id]))
            end
            ...
            context "when a postcode search returns an error" do
              ...
              it "redirects to the contact_address_manual form" do
                post contact_postcode_forms_path(transient_registration._id), contact_postcode_form: valid_params
                expect(response).to redirect_to(new_contact_address_manual_form_path(transient_registration[:_id]))
              end
            end
          end
      ...
      context "when a valid user is signed in" do
        ...
        context "when a valid transient registration exists" do
          ...
          context "when the back action is triggered" do
            it "returns a 302 response" do
              get back_contact_postcode_forms_path(transient_registration[:_id])
              expect(response).to have_http_status(302)
            end
      ...
      context "when a valid user is signed in" do
        ...
        context "when a valid transient registration exists" do
          ...
          context "when the skip_to_manual_address action is triggered" do
            it "returns a 302 response" do
              get skip_to_manual_address_contact_postcode_forms_path(transient_registration[:_id])
              expect(response).to have_http_status(302)
            end

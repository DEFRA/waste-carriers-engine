        ...
        context "when a valid transient registration exists" do
          ...
          context "when valid params are submitted" do
            ...
            it "increases the number of key_people" do
              ...
              post main_people_forms_path(transient_registration._id), main_people_form: valid_params
            ...
            it "redirects to the declare_convictions form" do
              post main_people_forms_path(transient_registration._id), main_people_form: valid_params
              expect(response).to redirect_to(new_declare_convictions_form_path(transient_registration[:_id]))
            end
            ...
            context "when the submit params say to add another" do
              it "redirects to the main_people form" do
                post main_people_forms_path(transient_registration._id), main_people_form: valid_params, commit: "Add another person"
                expect(response).to redirect_to(new_main_people_form_path(transient_registration[:_id]))
              end
            end
          end
          ...
          context "when invalid params are submitted" do
            ...
            it "does not increase the number of key_people" do
              key_people_count = transient_registration.key_people.count
              post main_people_forms_path(transient_registration._id), main_people_form: invalid_params
              expect(transient_registration.reload.key_people.count).to eq(key_people_count)
            end
          ...
          context "when blank params are submitted" do
            ...
            it "does not increase the number of key people" do
              key_people_count = transient_registration.key_people.count
              post main_people_forms_path(transient_registration._id), main_people_form: blank_params
              expect(transient_registration.reload.key_people.count).to eq(key_people_count)
            end
          end
        end
      ...
      context "when a valid user is signed in" do
        ...
        context "when a valid transient registration exists" do
          ...
          context "when the back action is triggered" do
            it "returns a 302 response" do
              get back_main_people_forms_path(transient_registration[:_id])
              expect(response).to have_http_status(302)
            end
            ...
            context "when the address was selected from OS places" do
              ...
              it "redirects to the company_address form" do
                get back_main_people_forms_path(transient_registration[:_id])
                expect(response).to redirect_to(new_company_address_form_path(transient_registration[:_id]))
              end
            end
            ...
            context "when the address was manually entered" do
              ...
              it "redirects to the company_address_manual form" do
                get back_main_people_forms_path(transient_registration[:_id])
                expect(response).to redirect_to(new_company_address_manual_form_path(transient_registration[:_id]))
              end
            end
          end
        end
        ...
        context "when a valid transient registration exists" do
          ...
          context "when the registration has key people" do
            ...
            context "when the delete person action is triggered" do
              it "returns a 302 response" do
                delete delete_person_main_people_forms_path(main_person_a[:id], _id: transient_registration._id)
                expect(response).to have_http_status(302)
              end

      ...
      context "when a valid user is signed in" do
        ...
        context "when a valid transient registration exists" do
          ...
          it "creates a new order" do
            get new_bank_transfer_form_path(transient_registration._id)
          ...
          context "when the workflow_state matches the requested form" do
            ...
            context "when the request is successful" do
              it "updates the transient registration metadata attributes from application configuration" do
                ...
                post_form_with_params(:bank_transfer_form, transient_registration._id)
        ...
        context "when a valid transient registration exists" do
          ...
          context "when the back action is triggered" do
            it "returns a 302 response" do
              get back_bank_transfer_forms_path(transient_registration._id)

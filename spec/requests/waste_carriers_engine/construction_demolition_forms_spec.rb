        ...
        context "when a valid transient registration exists" do
          ...
          context "when the back action is triggered" do
            it "returns a 302 response" do
              get back_construction_demolition_forms_path(transient_registration._id)
            ...
            context "when the business does not carry waste for other businesses or households" do
              ...
              it "redirects to the other_businesses form" do
                get back_construction_demolition_forms_path(transient_registration._id)
                expect(response).to redirect_to(new_other_businesses_form_path(transient_registration._id))
              end
            end
            ...
            context "when the business does carry waste for other businesses or households" do
              ...
              it "redirects to the service_provided form" do
                get back_construction_demolition_forms_path(transient_registration._id)
                expect(response).to redirect_to(new_service_provided_form_path(transient_registration._id))
              end
            end
          end
        end

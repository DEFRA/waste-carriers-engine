...
module WasteCarriersEngine
  RSpec.describe "BusinessNameForms", type: :request do
    include_examples "GET flexible form", "business_name_form"

    describe "POST business_name_form_path" do
      include_examples "POST renewal form",
                       "business_name_form",
                       valid_params: { business_name: "WasteCo Ltd" },
                       invalid_params: { business_name: "" },
                       test_attribute: :business_name

      context "When the transient_registration is a new registration" do
        let(:transient_registration) do
          create(:new_registration, :has_required_data, workflow_state: "business_name_form")
        end
    ...
    describe "GET back_business_name_forms_path" do
        ...
        context "when a valid transient registration exists" do
          let(:transient_registration) do
            create(:renewing_registration,
                   ...
                   workflow_state: "business_name_form")
          end
          ...
          context "when the back action is triggered" do
            context "when the business type is localAuthority" do
              ...
              it "returns a 302 response and redirects to the renewal_information form" do
                get back_business_name_forms_path(transient_registration[:token])

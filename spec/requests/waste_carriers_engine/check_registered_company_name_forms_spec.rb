...
module WasteCarriersEngine
  RSpec.describe "CheckRegisteredCompanyNameForms", type: :request do
    ...
    describe "POST check_registered_company_name_form_path" do
      ...
      #                    valid_params: { temp_use_registered_company_details: "yes", companies_house_check.company_name: "09360070"},
      #                    invalid_params: { temp_use_registered_company_details: "foo", companies_house_check.company_name: "09360070" }
      # end
      end
    end 

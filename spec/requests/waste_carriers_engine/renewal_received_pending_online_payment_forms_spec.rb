...
module WasteCarriersEngine
  RSpec.describe "RenewalReceivedPendingOnlinePaymentForms", type: :request do
    describe "GET new_renewal_received_pending_online_payment_form_path" do
      context "when a valid user is signed in" do
        ...
        context "when no renewing registration exists" do
          it "redirects to the invalid page" do
            get new_renewal_received_pending_online_payment_form_path("wibblewobblejellyonaplate")
        ...
        context "when a valid renewing registration exists" do
          let(:transient_registration) do
            create(
              ...
              :has_unpaid_balance,
              workflow_state: "renewal_received_pending_online_payment_form",
          ...
          context "when the workflow_state is correct" do
            it "returns a 200 status and renders the :new template" do
              get new_renewal_received_pending_online_payment_form_path(transient_registration.token)

...
module WasteCarriersEngine
  RSpec.describe TransientRegistration, type: :model do
    ...
    describe "#pending_card_payment?" do
      context "when the renewal has an order" do
        ...
        context "when the order's world_pay_status is pending" do
          ...
          it "returns true" do
            expect(transient_registration.pending_card_payment?).to eq(true)
          end
        end
        ...
        context "when the order's world_pay_status is not pending" do
          ...
          it "returns false" do
            expect(transient_registration.pending_card_payment?).to eq(false)
          end
        end
      end

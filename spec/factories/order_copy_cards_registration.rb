...
FactoryBot.define do
  factory :order_copy_cards_registration, class: WasteCarriersEngine::OrderCopyCardsRegistration do
    ...
    trait :has_finance_details do
      after(:build, :create) do |order_copy_cards_registration|
        WasteCarriersEngine::FinanceDetails.new_finance_details(order_copy_cards_registration, :worldpay, build(:user))
      end
    end
